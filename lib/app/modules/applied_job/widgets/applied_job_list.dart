...
//future buider
  ...
  Widget build(BuildContext context) {
    return Obx(() => controller.isRefresh.value
            ...
            builder: ((context, snapshot) {
              ...
              if (snapshot.hasData) {
                return Obx(() => LazyLoadingList(
                      ...
                      itemCount: controller.appliedJobPostResponse.length,
                      itemBuilder: ((context, index) {
                        if (controller.appliedJobPostResponse.isEmpty) {
                          return Center(
                            child: Column(
                              children: [
                                Text(
